...
public class DisplayDebugPlugin extends AbstractNodeAmPlugin {
	...
	static private String currentVersion = "0.1.10";
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(DisplayDebugPlugin.currentVersion, 
				Collections.singletonList(DisplayDebug.class));
	}
	...
	public String getPluginVersion() {
		return DisplayDebugPlugin.currentVersion;
	}
}
